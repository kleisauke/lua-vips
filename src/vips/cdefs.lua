...
ffi.cdef [[
    ...
    typedef struct _VipsArgumentNameFlags {
        const char *name;
        VipsArgumentFlags flags;
    } VipsArgumentNameFlags;

    typedef struct {
        VipsArgumentNameFlags **array;
        int n;
    } VipsArgumentNameFlagsArray;

    VipsArgumentNameFlagsArray *vips_object_get_args (VipsOperation *object);
